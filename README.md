...
ArkUnpacker v3.x 版本只适用于《明日方舟》v2.4.xx 及以下的游戏版本。自《明日方舟》v2.5.04 版本（2025 年 4 月发行）开始，游戏资源采用了新的压缩算法，ArkUnpacker 暂时无法处理这一重大变更。我们预计将于 ArkUnpacker **v4.x** 版本中解决这一问题。
